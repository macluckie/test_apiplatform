 ...
 */
final class Version20211212011459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, partner_id, name, first_name, email, roles, password, created FROM client');
        ...
        $this->addSql('INSERT INTO client (id, partner_id, name, first_name, email, roles, password, created) SELECT id, partner_id, name, first_name, email, roles, password, created FROM __temp__client');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, partner_id, name, first_name, email, roles, password, created FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, partner_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
